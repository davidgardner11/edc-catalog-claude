...
- **Zero-count facets stay enabled.** "No packs are white" is a true answer to a question a user is allowed to ask; a disabled checkbox hides it. They are muted, not removed and not disabled (ADR-034 point 6).
